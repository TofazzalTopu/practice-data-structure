package com.example.practice.datastructure.model.Multithreading.callable;
...
public class CallableExample implements Callable<Boolean> {
    ...
    public CallableExample(final String message, final long delay) {
    ...
    public static void main(String[] args) {
        ...
        input.forEach((message, delay) -> {
            ...
            final FutureTask<Boolean> futureTask = new FutureTask<>(
                    new CallableExample(message, delay)
            );
