package com.example.practice.datastructure.model.Multithreading.futureTask;

// Java program do two FutureTask using Runnable Interface
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            try {
                ...
                System.out.println(futureTask2.isCancelled());
